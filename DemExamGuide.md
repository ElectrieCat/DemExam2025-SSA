# Топология
![](images/DemExamGuide_20250526210516514.png)
# Полезности
...
## 4. [Выполнить позже всех] Настройте межсетевой экран на маршрутизаторах HQ-RTR и BR-RTR на сеть в сторону ISP
...
```
Или если мы не делали сертификаты, то следующий конфиг вместо предыдущего
```
server {
 listen 80;
 server_name mon.au-team.irpo;
...
ВАЖНО: Для роутеров здесь мы добавляем их адрес во внутренней сети, не WAN
